...
[![Java](https://img.shields.io/badge/Java-17-orange)](https://github.com/easy-4-java/spring-security-extension) [![License](https://img.shields.io/badge/license-Apache%202.0-green)](./LICENSE)
...
```groovy
implementation 'io.github.easy4j:spring-security-extension:2.0.x.x.20260630-SNAPSHOT'
```
